import { Music, Video, Users, Award, Piano, Clock, BookOpen, Guitar } from "lucide-react"
...
const features = [
  ...
  },
  {
    ...
    description: "Access a vast library of high-quality video tutorials from expert instructors.",
    icon: Video,
  },
  {
  ...
  },
  {
    ...
    description: "Track your practice time and progress with our built-in tools.",
    icon: Award,
  },
  {
